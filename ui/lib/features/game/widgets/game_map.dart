...
/// Diplomacy map: SVG background + CustomPaint overlay with pinch-to-zoom.
/// At default zoom the map fills its container and cannot be dragged.
/// When zoomed in, panning within the zoomed content is allowed.
