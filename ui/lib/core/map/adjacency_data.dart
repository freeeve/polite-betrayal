...
const _adjacencies = <Adjacency>[
  ...
  Adjacency(from: 'ank', to: 'smy', type: AdjType.both),
  Adjacency(from: 'apu', to: 'nap', type: AdjType.both),
  Adjacency(from: 'apu', to: 'rom', type: AdjType.both),
  Adjacency(from: 'apu', to: 'ven', type: AdjType.both),
  Adjacency(from: 'arm', to: 'sev', type: AdjType.both),
  Adjacency(from: 'arm', to: 'smy', type: AdjType.both),
  ...
  Adjacency(from: 'edi', to: 'lvp', type: AdjType.both),
  Adjacency(from: 'edi', to: 'yor', type: AdjType.both),
  Adjacency(from: 'fin', to: 'nwy', type: AdjType.both),
  ...
  Adjacency(from: 'lvp', to: 'yor', type: AdjType.both),
  ...
  Adjacency(from: 'wal', to: 'yor', type: AdjType.both),
  ...
  Adjacency(from: 'apu', to: 'ven', type: AdjType.army), // already both, but also army
