...
func midGameState() *diplomacy.GameState {
	return &diplomacy.GameState{
		...
		Units: []diplomacy.Unit{
			...
			{Type: diplomacy.Army, Power: diplomacy.France, Province: "bur", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Army, Power: diplomacy.France, Province: "pie", Coast: diplomacy.NoCoast},
			...
			{Type: diplomacy.Fleet, Power: diplomacy.France, Province: "por", Coast: diplomacy.NoCoast},
			// England (5 units)
			{Type: diplomacy.Fleet, Power: diplomacy.England, Province: "nth", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Fleet, Power: diplomacy.England, Province: "eng", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Fleet, Power: diplomacy.England, Province: "nwg", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Army, Power: diplomacy.England, Province: "lon", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Army, Power: diplomacy.England, Province: "edi", Coast: diplomacy.NoCoast},
			// Germany (4 units)
			{Type: diplomacy.Army, Power: diplomacy.Germany, Province: "mun", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Army, Power: diplomacy.Germany, Province: "ruh", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Fleet, Power: diplomacy.Germany, Province: "kie", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Fleet, Power: diplomacy.Germany, Province: "den", Coast: diplomacy.NoCoast},
			// Russia (4 units)
			{Type: diplomacy.Army, Power: diplomacy.Russia, Province: "war", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Army, Power: diplomacy.Russia, Province: "mos", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Fleet, Power: diplomacy.Russia, Province: "sev", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Fleet, Power: diplomacy.Russia, Province: "swe", Coast: diplomacy.NoCoast},
			// Turkey (4 units)
			{Type: diplomacy.Army, Power: diplomacy.Turkey, Province: "con", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Army, Power: diplomacy.Turkey, Province: "bul", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Fleet, Power: diplomacy.Turkey, Province: "ank", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Fleet, Power: diplomacy.Turkey, Province: "bla", Coast: diplomacy.NoCoast},
			// Austria (3 units)
			{Type: diplomacy.Army, Power: diplomacy.Austria, Province: "vie", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Army, Power: diplomacy.Austria, Province: "bud", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Fleet, Power: diplomacy.Austria, Province: "tri", Coast: diplomacy.NoCoast},
			// Italy (3 units)
			{Type: diplomacy.Army, Power: diplomacy.Italy, Province: "ven", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Army, Power: diplomacy.Italy, Province: "rom", Coast: diplomacy.NoCoast},
			{Type: diplomacy.Fleet, Power: diplomacy.Italy, Province: "nap", Coast: diplomacy.NoCoast},
		},
		SupplyCenters: map[string]diplomacy.Power{
			// France (7 SCs)
